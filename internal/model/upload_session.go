...
func GetUploadSession(userID uint, storageKey string) (*UploadSession, error) {
	var s UploadSession
...
func ListUploadSessions(userID uint) ([]UploadSession, error) {
...
func DeleteUploadSession(userID uint, storageKey string) error {
